...
RUN wget "https://github.com/xtaci/kcptun/releases/download/v20190418/kcptun-linux-arm64-20190418.tar.gz" -O kcp.tar.gz
RUN tar xvf kcp.tar.gz; mv client_linux_arm64 kcp_client; mv server_linux_arm64 kcp_server
